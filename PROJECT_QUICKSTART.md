...
## Repeated-use flow (daily operator path)

1. Open active plan in [`plans/active/`](plans/active/).
2. Resume from current stage.
3. Run and record validations.
4. Update docs if behavior/constraints changed.
...
3. `docs/protocols/`
4. `docs/standards/`
5. `docs/templates/` and repository conventions

## Related

- Operator manual: [`HOW_TO_USE_THIS_PROJECT.md`](HOW_TO_USE_THIS_PROJECT.md)
- Examples index: [`docs/examples/README.md`](docs/examples/README.md)
- Failure and recovery protocol: [`docs/protocols/failure_and_recovery.md`](docs/protocols/failure_and_recovery.md)
